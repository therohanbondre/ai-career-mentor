...
- **Issues de GitHub:** [Abrir un issue](https://github.com/therohanbondre/Resume-Matcher/issues) para bugs o solicitudes de funcionalidades
...
¡Feliz creación de currículums! Si Resume Matcher te resulta útil, considera [darle una estrella al repo](https://github.com/therohanbondre/Resume-Matcher) y [unirte a nuestro Discord](https://dsc.gg/resume-matcher).
